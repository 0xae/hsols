...
namespace WebcommandBundle\Controller;
...
class WebcommandBundleController extends Controller
{
    
    /**
     * @Route("/command-runner")
     * @Template()
     */
    ...
    /**
     * @Route("/command-runner/{commandName}",  name="commandrunner")
     * @Template()     
     * @param $commandName
